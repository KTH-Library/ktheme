...
kth <- function(number_sections = FALSE,
  ...
  dep <- htmltools::htmlDependency(
    name = "kth",
    version = "0.1.0",
    system.file("rmarkdown", "templates", "kth", "resources", package = "ktheme"),
  ...
  args <- c(
    ...
    rmarkdown::pandoc_path_arg(
      system.file("rmarkdown", "templates", "kth", "base.html", package = "ktheme")
    )
  )
...
#'        base R Markdown HTML output formatter
#' @export
kth_neo <- function(number_sections = FALSE,
                  fig_width = 7,
                  fig_height = 5,
                  fig_retina = if (!fig_caption) 2,
                  fig_caption = FALSE,
...
#                   "figtree.css", "georgia.css")
  ...
  args <- c(
    args, "--template",
    rmarkdown::pandoc_path_arg(
      system.file("rmarkdown", "templates", "kth_neo", "base.html", package = "ktheme")
    )
  )
